...
export const RELIEF_FAQ: { cat: string; q: string; a: string }[] = [
  ...
  { cat: 'sports', q: 'Is gym membership claimable, and what about sportswear?', a: 'Gym membership and sports training from a registered club, association or company count under the RM1,000 sports relief, together with equipment, facility fees and licensed competition fees. Sportswear, fitness trackers and motorised two-wheel bicycles do not.' },
