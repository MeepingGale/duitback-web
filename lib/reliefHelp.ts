...
export const RELIEF_HELP: Record<string, ReliefHelp> = {
  ...
  sports: {
    ...
    can: [
      ...
      'Gym membership from a registered gym, including the classes it runs.',
      'Training, classes or coaching for one of the 103 sports gazetted under the Sports Development Act, from a club or company registered with the Commissioner of Sports or incorporated under the Companies Act.',
    ],
    lists: [
      { title: 'Equipment counts', items: ['badminton racket', 'shuttlecocks', 'golf set', 'footballs', 'bicycle', 'dumbbells', 'treadmill', 'yoga mat', 'swimming goggles'] },
      { title: 'Facilities', items: ['courts', 'pools', 'fields', 'climbing gyms', 'driving ranges'] },
    ],
    cant: [
      'Sports attire of any kind: running shoes, football boots, jerseys, swimsuits, leggings. LHDN counts these as clothing, not equipment.',
      'Fitness trackers, smartwatches, motorised two-wheel bicycles.',
      'Classes for an activity not on the Sports Development Act list, such as pilates at a studio; the same class inside a registered gym membership is fine.',
      'Coaching from an unregistered individual.',
    ],
    proof: 'Receipts in your name; for competitions, the organiser\'s details.',
    bm: 'Peralatan sukan, sewa atau tiket masuk kemudahan sukan, yuran pertandingan berlesen, keahlian gim dan latihan bagi 103 sukan di bawah Akta Pembangunan Sukan. Kasut, pakaian sukan dan basikal bermotor tidak termasuk.',
  },
  epf: {
    who: 'You',
    can: [
...
/** Questions people actually search, answered from the same source. Shown on the public reliefs page. */
export const RELIEF_FAQ: { cat: string; q: string; a: string }[] = [
  { cat: 'medical', q: 'Can I claim chiropractic, physiotherapy or TCM under the medical relief?', a: 'No. LHDN accepts medical expenses only with a receipt and certification from a practitioner registered with the Malaysian Medical Council, and only for the listed categories: serious diseases, fertility treatment, vaccination, dental, check-ups and mental health, and a child\'s learning disability. Chiropractors, physiotherapists and TCM practitioners are not MMC-registered, so their bills do not qualify, for you or for your parents.' },
  { cat: 'medical', q: 'Which vaccines qualify for the RM1,000 vaccination relief?', a: 'From YA2026, any vaccine registered with and approved by the Ministry of Health. For YA2025 and earlier the list was fixed: pneumococcal, HPV, influenza, rotavirus, varicella, meningococcal, Tdap and COVID-19. The RM1,000 is shared across you, your spouse and your children.' },
  { cat: 'medical', q: 'How much of the RM10,000 medical relief can a healthy person actually use?', a: 'About RM3,000: RM1,000 for a full check-up or mental-health consultation, RM1,000 for vaccinations and RM1,000 for dental. The rest only opens up with treatment of a listed serious disease, fertility treatment or a child\'s learning-disability programme.' },
  { cat: 'lifestyle', q: 'Does the extended warranty on a laptop or phone count under lifestyle relief?', a: 'No. LHDN excludes the additional charge for warranty. The device itself counts, up to the RM2,500 cap, as long as it is not used for your own business.' },
  { cat: 'sports', q: 'Are running shoes, sportswear or pilates classes claimable under the sports relief?', a: 'No to all three. LHDN treats running shoes, boots, jerseys and swimsuits as attire rather than equipment, so they qualify under neither the sports nor the lifestyle relief. Pilates is not among the 103 sports gazetted under the Sports Development Act 1997, so a pilates studio\'s fees are out, although classes included in a registered gym membership ride along with the membership. Rackets, balls, golf sets, dumbbells, a yoga mat, swimming goggles, facility entry fees and licensed competition fees do count.' },
  { cat: 'childcare', q: 'Can both husband and wife claim the RM3,000 childcare relief?', a: 'Not under separate assessment: only the spouse who paid claims it, and the RM3,000 is a total however many children you have. From YA2026 the child may be up to 12 years old and registered daycare and after-school transit centres count too.' },
  { cat: 'sspn', q: 'Does an SSPN withdrawal affect my relief?', a: 'Yes. The relief is on the net deposit for the year: deposits minus withdrawals, capped at RM8,000, and the opening balance is ignored. A withdrawal in the same year reduces the claim even if it paid university fees.' },
  ...
  { cat: 'parents_med', q: 'What can I claim for my parents\' medical expenses?', a: 'Up to RM8,000 for medical treatment in Malaysia certified by an MMC doctor, dental treatment certified by a Malaysian Dental Council dentist, special needs and a carer when a doctor certifies the need, and a full medical examination including vaccination up to RM1,000. Grandparents count from YA2025; parents-in-law do not.' },
  { cat: 'edu_self', q: 'Which courses qualify for the RM7,000 education fees relief?', a: 'Any masters or doctorate at a recognised Malaysian institution, courses up to first degree in law, accounting, Islamic finance, technical, vocational, industrial, scientific or technological fields, and skills-council courses up to RM2,000. Your own fees only, not your children\'s.' },
];
