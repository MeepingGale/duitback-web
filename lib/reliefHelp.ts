...
export const RELIEF_FAQ: { cat: string; q: string; a: string }[] = [
  ...
  { cat: 'housing', q: 'Is the first-home loan interest relief based on the house price or on what I paid?', a: 'On the interest you actually paid in the year, as shown on the bank\'s annual statement: not the price, the loan amount or the instalments, and not the principal part of a repayment. The price only sets the ceiling: up to RM7,000 a year if the home cost RM500,000 or less, up to RM5,000 if it cost RM500,001 to RM750,000, and nothing above that. It runs for three consecutive years from the first year interest is paid, for a first home you live in, bought under a sale and purchase agreement signed between 1 January 2025 and 31 December 2027; co-owners split the ceiling in proportion to the interest each paid.' },
];
